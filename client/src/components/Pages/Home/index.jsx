...
const Home = () => {
  ...
  <div class="cont">
        <div class="banner" >
            ...
            <img class="banner-image" src={banner_image} alt="banner" id="banner-image-wide"></img>
            <img class="banner-image-2" src={banner_image_2.png} alt="banner_2" id="banner-image"></img>
